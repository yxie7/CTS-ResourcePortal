...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <link href="css.css" rel="stylesheet" />
        ...
        <asp:LinkButton CssClass="btn btn-link" runat="server" ID="btnUsers" Text="New Citizens" OnClick="btnUsers_Click" style="font-size: 30px;
    margin-right: 6%;"></asp:LinkButton>
            </div>
    <div class="container">
         <div class="col row">
