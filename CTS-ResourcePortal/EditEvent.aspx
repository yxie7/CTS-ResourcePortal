...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
        ...
        <div id="" class="section">
            ...
            <div class="row" id="titleRow">
                <div class="col-sm-6">
                    ...
                    <input type="text" ID="txtTitle" class="form-control" runat="server" required>                </div>
                <div class="col-sm-6">
	...
	<asp:ListItem Value="PA">Pennsylvania</asp:ListItem>
            ...
            <div class="row" id="linkdiv">
                <div class="col-sm-6">
                    <asp:Label ID="lblAttire" runat="server">Attire: </asp:Label><br />
                    <input type="text" ID="txtAttire" class="form-control" runat="server">
                </div>
                <div class="col-sm-6">
                    <asp:Label ID="lblLink" runat="server"><span class="requiredRed">*</span>Link: </asp:Label><br />
            ...
            <div class="row justify-content-center align-items-center">
                    <asp:Button ID="btnSubmit" runat="server" Text="Edit Event" Width="200px" OnClick="btnSubmit_click"  CssClass="btn btn-primary"/>
            </div>
        </div>
    </div>
</asp:Content>